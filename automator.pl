...
my $prefix          =   "Ecoli";                # prefix for all intermediate files
my $dir             =   "intermediates";        # location of where to put intermediates

my $strain          =   "SP";                   # which cas9 do you want to use
my $guideFile       =   "S288C_ARS103_ARS103_genomic.fsa";  # name of your guide RNA file

my $finalOutput     =   $timestamp . "_EcoliResults.txt";

##########################################################################################
# User, please fill in information above. DO NOT CHANGE ANYTHING BELOW THIS POINT!!
##########################################################################################
